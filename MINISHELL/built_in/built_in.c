...
{
	if (list->com && ft_strcmp(list->com, "echo\0") == 0)
		return (ft_echo(va, list->arguments));
	else if (list->com && ft_strcmp(list->com, "export\0") == 0)
	{
		va->envi = export1(va, list->arguments, va->envi);
		return (1);
	}
	else if (list->com && ft_strcmp(list->com, "unset\0") == 0)
	{
...
{
	if (list->com && ft_strcmp(list->com, "exit\0") == 0)
		return (ft_exit(va, list));
	else if (list->com && ft_strcmp(list->com, "pwd\0") == 0)
		return (ft_pwd(va));
	else if (list->com && ft_strcmp(list->com, "env\0") == 0)
		return (print_tab(va->envi));
	else if (list->com && ft_strcmp(list->com, "cd\0") == 0)
	{
		if (ft_cd(va, list->arguments) != 1)
			va->watatus = 257;
		return (1);
	}
	else if (list->com && ft_strcmp(list->com, "hex\0") == 0)
		return (print_hex(va));
